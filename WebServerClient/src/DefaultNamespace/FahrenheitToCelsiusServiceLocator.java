...
public class FahrenheitToCelsiusServiceLocator extends org.apache.axis.client.Service implements DefaultNamespace.FahrenheitToCelsiusService {
    ...
    private java.lang.String FahrenheitToCelsius_address = "http://localhost:8080/WebServer/services/FahrenheitToCelsius";
    ...
    public DefaultNamespace.FahrenheitToCelsius getFahrenheitToCelsius() throws javax.xml.rpc.ServiceException {
    ...
    public DefaultNamespace.FahrenheitToCelsius getFahrenheitToCelsius(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            DefaultNamespace.FahrenheitToCelsiusSoapBindingStub _stub = new DefaultNamespace.FahrenheitToCelsiusSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (DefaultNamespace.FahrenheitToCelsius.class.isAssignableFrom(serviceEndpointInterface)) {
                DefaultNamespace.FahrenheitToCelsiusSoapBindingStub _stub = new DefaultNamespace.FahrenheitToCelsiusSoapBindingStub(new java.net.URL(FahrenheitToCelsius_address), this);
                _stub.setPortName(getFahrenheitToCelsiusWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://DefaultNamespace", "FahrenheitToCelsiusService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://DefaultNamespace", "FahrenheitToCelsius"));
        }
