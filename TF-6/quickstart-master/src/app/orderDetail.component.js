...
var OrderDetailComponent = (function () {
    ...
    OrderDetailComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.paramMap
            .switchMap(function (params) { return _this.orderService.getOrderDetail(+params.get('orderId')); })
            .subscribe(function (orderDetail) { return _this.orderDetail = orderDetail; });
    };
