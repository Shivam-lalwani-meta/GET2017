...
var DashboardComponent = (function () {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        this.productService.getProducts().then(function (response) {
            ...
            console.log(_this.products[9].source);
        });
    };
    DashboardComponent.prototype.getProductDetail = function (selectedProduct) {
        this.router.navigate(['/getProductDetail', selectedProduct.id]);
    };
